...
namespace QuizGame.API.LIBS
{
    public class FlexiMail
    {
        ...
        public void Send()
        {
            ...
            SmtpClient client = new SmtpClient();
            client.Host = " mail.dotsquares.com";
            client.Credentials = new System.Net.NetworkCredential("wwwsmtp@dotsquares.com", "dsmtp909#");
            client.Port = 587;

            //SmtpClient client = new SmtpClient();
            //client.Host = " mail.dotsquares.com";
            //client.Credentials = new System.Net.NetworkCredential("dstesting@dotsquares.com", "l0!CEpoo?^i&amp;");
            //client.Port = 587;

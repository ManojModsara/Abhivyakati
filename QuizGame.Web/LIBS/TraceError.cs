...
namespace QuizGame.Web.LIBS
{
    ...
    {
        public static void ReportError(System.Exception exception, string ReportToEmail = "narottam.sharma@dotsquares.com", string ApplicationTitle = "")
        {
            if ((exception != null))
            {
                try
                {
                    ...
                    ErrorDesc += "<H3>Error Occured " + (SiteKey.DomainName.Contains("localhost") ? "Test" : "Live") + "</h3><hr>";
